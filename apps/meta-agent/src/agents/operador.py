...
from src.tools.write_ops import (
    ...
    set_tenant_home_channel,
    stop_tenant,
    update_tenant_allowed_users,
    update_tenant_model,
...
operador = Agent(
    ...
    instructions=[
        ...
        "",
        "## Seguridad — usuarios autorizados del bot del cliente",
        "Cada tenant tiene TELEGRAM_ALLOWED_USERS en su .env — solo esos IDs pueden",
        "hablar con el bot de Hermes del cliente. Hermes recarga el .env en cada turno,",
        "así que los cambios aplican de inmediato sin reiniciar el container.",
        "Para añadir un usuario: update_tenant_allowed_users(code, ['ID'], mode='add')",
        "Para quitar un usuario: update_tenant_allowed_users(code, ['ID'], mode='remove')",
        "Para reemplazar: update_tenant_allowed_users(code, ['ID1','ID2'], mode='replace')",
        "Nunca dejes la lista vacía — el bot quedaría inaccesible para el cliente.",
        "Los IDs se obtienen hablándole a @userinfobot en Telegram.",
        "",
